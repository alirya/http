import {VariantAlsoNegotiatesParameters, VariantAlsoNegotiatesParameter} from '../../../dist/response/variant-also-negotiates';
...
describe('message', function() {
    ...
    it('parameters', function() {
        ...
        let response = VariantAlsoNegotiatesParameters(undefined,{},'etag data');
...
describe('body', function() {
    ...
    it('parameters', function() {
        ...
        let response = VariantAlsoNegotiatesParameters('data', undefined);
