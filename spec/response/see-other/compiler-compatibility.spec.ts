import {SeeOtherParameters, SeeOtherParameter} from '../../../dist/response/see-other';
...
describe('message', function() {
    ...
    it('parameters', function() {
        ...
        let response = SeeOtherParameters(undefined,{},'etag data');
...
describe('body', function() {
    ...
    it('parameters', function() {
        ...
        let response = SeeOtherParameters('data', undefined);
