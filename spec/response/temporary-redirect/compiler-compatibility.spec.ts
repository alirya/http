import {TemporaryRedirectParameters, TemporaryRedirectParameter} from '../../../dist/response/temporary-redirect';
...
describe('message', function() {
    ...
    it('parameters', function() {
        ...
        let response = TemporaryRedirectParameters(undefined,{},'etag data');
...
describe('body', function() {
    ...
    it('parameters', function() {
        ...
        let response = TemporaryRedirectParameters('data', undefined);
