import {PermanentRedirectParameters, PermanentRedirectParameter} from '../../../dist/response/permanent-redirect';
...
describe('message', function() {
    ...
    it('parameters', function() {
        ...
        let response = PermanentRedirectParameters(undefined,{},'etag data');
...
describe('body', function() {
    ...
    it('parameters', function() {
        ...
        let response = PermanentRedirectParameters('data', undefined);
